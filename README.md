...
1. Download software and supporting packages.
    ...
    ```
    $ go get github.com/bigangryrobot/go-vnc
...
- Connect and listen to server messages: <https://godoc.org/github.com/bigangryrobot/go-vnc#example-Connect>
...
[CIProject]: https://travis-ci.org/bigangryrobot/go-vnc
[CIStatus]: https://travis-ci.org/bigangryrobot/go-vnc.png?branch=master

[GoDoc]: https://godoc.org/github.com/bigangryrobot/go-vnc
[GoDocStatus]: https://godoc.org/github.com/bigangryrobot/go-vnc?status.svg
